...
export const meta = {
  title:
    "Tailwind CSS v3.2: Dynamic breakpoints, multi-config, and container queries, oh my! --B",
  description:
    "...and nested group support, `aria-*` variants, `data-*` variants, `@supports` support, and more. -B",
...
<div className="my-8">
  <img src={card.src} alt="Tailwind CSS v3.2" />
</div>
...
<h2 id="multiple-config-files-in-one-project-using-config">
...
<h2 id="browser-support-based-styling-with-supports">
...
<h2 id="aria-attribute-variants">ARIA attribute variants</h2>
...
<h2 id="data-attribute-variants">Data attribute variants</h2>
...
<h2 id="dynamic-group-and-peer-variants">
...
<h2 id="dynamic-variants-with-matchvariant">
...
<h2 id="nested-group-and-multiple-peer-support-using-variant-modifiers">
