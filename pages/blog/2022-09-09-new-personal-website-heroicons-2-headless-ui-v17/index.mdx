...
<div className="my-8">
  <a href="https://tailwindui.com/templates/spotlight">
    <img src={spotlightPreview.src} alt="Learn about the Spotlight template"/>
  </a>
</div>
...
<div className="my-8">
  <a href="https://spotlight.tailwindui.com">
    <img src={spotlightDetail.src} alt="Preview the Spotlight template"/>
  </a>
</div>
...
<div className="my-8">
  <a href="https://heroicons.com">
    <img src={heroiconsCover.src} alt="Heroicons v2.0"/>
  </a>
</div>
...
<div className="my-8">
  <a href="https://headlessui.com">
    <img src={headlessuiCard.src} alt="Headless UI v1.7"/>
  </a>
</div>
...
<div className="my-8">
  <a href="https://play.tailwindcss.com">
    <img src={playInsiders.src} alt="Tailwind Play insiders option"/>
  </a>
</div>
...
<div className="my-8">
  <img src={phoenix.src} alt="New designs for Phoenix v1.7"/>
</div>
