 ...
 *   lang: 'css',
 *   meta: 'Generated CSS',
 *   value: '.group.is-published .group-\\[\\.is-published\\]\\:block {\n  display: block;\n}',
 *   position: Position {
 *     start: { line: 365, column: 1, offset: 13637 },
 *     end: { line: 369, column: 4, offset: 13736 },
 *     indent: [ 1, 1, 1, 1 ]
 *   }
 * }
 * @returns
...
module.exports.withPrevalInstructions = () => {
  return (tree, VFile) => {
    ...
    console.log("withPrevalInstructions", context);
