...
const Testimonials: React.FC<TestimonialsProps> = () => {
  ...
  return (
    ...
    >
      ...
      >
        {testimonials.map((columeData: ITestimonialItem[], i: number) => {
          return (
            <ul
              key={i}
              className={clsx(
      ...
      >
        <button
          type="button"
          className={clsx(
            'relative text-sm !bg-slate-900 hover:!bg-slate-700 text-white font-semibold h-12 px-6 rounded-lg flex items-center pointer-events-auto',
